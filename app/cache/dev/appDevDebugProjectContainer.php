...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/ology4/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/ology4/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_3a611848f2188e77bebba67f0862fdbc');

        $b = new \Doctrine\Common\Cache\ApcCache();
        $b->setNamespace('sf2orm_default_3a611848f2188e77bebba67f0862fdbc');

        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_default_3a611848f2188e77bebba67f0862fdbc');
        ...
        $f->setProxyDir('/var/www/ology4/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getKnpZendCache_ManagerService()
    {
        ...
        $instance->setCacheTemplate('estrisa_twig_image_tag', array('frontend' => array('name' => 'Core', 'options' => array('lifetime' => 2592000, 'automatic_serialization' => true)), 'backend' => array('name' => 'File', 'options' => array('cache_dir' => '/var/www/ology4/app/cache/dev'))));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/ology4/app/logs/dev.log', 200, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/var/www/ology4/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/ology4/app/config/routing_dev.yml', array('cache_dir' => '/var/www/ology4/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/ology4/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/ology4/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/ology4/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/ology4/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/ology4/app/cache/dev',
            ...
            'debug.container.dump' => '/var/www/ology4/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'sqlite:/var/www/ology4/app/cache/dev/profiler.db',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/ology4/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/var/www/ology4/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/var/www/ology4/app/cache/dev/assetic',
            ...
            'jms_aop.cache_dir' => '/var/www/ology4/app/cache/dev/jms_aop',
