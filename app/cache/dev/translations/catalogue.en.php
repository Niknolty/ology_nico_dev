...
',
    ...
    'resetting.email' => 'Ology reset password request
<img src="{{websiteUrl}}{{ asset(\'bundles/ologysocial/img/emailheader.jpg\') }}" />
<p>
...
',
    ...
    'fos_user_registration_form_termOfService' => 'I agree to the Term of services:',
