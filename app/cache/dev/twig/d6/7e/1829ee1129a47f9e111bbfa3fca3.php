...
class __TwigTemplate_d67e1829ee1129a47f9e111bbfa3fca3 extends Twig_Template
{
    ...
    {
        // line 1
        echo "Create video post

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_post_store_video"), "html", null, true);
        echo "\" method=\"post\" ";
    ...
    {
        return "OlogySocialBundle:Post:create_video.html.twig";
    }
