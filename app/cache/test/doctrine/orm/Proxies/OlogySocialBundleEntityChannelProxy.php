...
class OlogySocialBundleEntityChannelProxy extends \Ology\SocialBundle\Entity\Channel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'imageLogo', 'imageTitle', 'managedBy', 'name', 'stub', 'featuredPost1', 'featuredPost2', 'featuredPost3', 'featuredPost4', 'featuredPost5', 'specialPost1', 'specialPost2', 'specialPost3', 'ad0', 'ad1', 'ad2', 'ad3', 'ad4', 'ad5', 'ad6', 'display', 'video', 'specialTitle', 'subscriptions');
    }
