...
/* OlogySocialBundle:Follow:followers.html.twig */
class __TwigTemplate_619fd6be800f1b99b3449d55d9e81479 extends Twig_Template
{
    ...
    <h1>Who Follows ";
        ...
        echo "<button id=\"close-followees-page\"></button></h1>
    ";
        // line 3
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "followers"));
        foreach ($context['_seq'] as $context["_key"] => $context["follower"]) {
            // line 4
            echo "        <div class=\"follower-card\">
            <a href=\"";
            // line 5
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_profile", array("id" => $this->getAttribute($this->getContext($context, "follower"), "id"))), "html", null, true);
            echo "\">
                <img src=\"";
            // line 6
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("bundles/ologysocial/up/img/user/user_large/" . $this->getAttribute($this->getContext($context, "follower"), "imageUrl"))), "html", null, true);
            echo "\" />
            </a>
            ...
            echo "\">
                    ";
            // line 10
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "follower"), "firstname"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "follower"), "lastname"), "html", null, true);
            echo "
                </a>
                <div class=\"follower-summary\">";
            // line 12
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "follower"), "summary"), "html", null, true);
            echo "</div>
                
                ";
            // line 14
            if (((!twig_test_empty($this->getAttribute($this->getContext($context, "app"), "user"))) && ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "user"), "id") != $this->getAttribute($this->getContext($context, "follower"), "id")))) {
                // line 15
                echo "                    ";
                if (twig_in_filter($this->getAttribute($this->getContext($context, "follower"), "id"), $this->getContext($context, "followedUsers"))) {
                    // line 16
                    echo "                        <div class=\"following-button\" id=\"follow-button\" href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_follow_user_popup", array("userId" => $this->getAttribute($this->getContext($context, "follower"), "id"))), "html", null, true);
                    echo "\"/>
                    ";
                } else {
                    // line 18
    ...
    {
        return "OlogySocialBundle:Follow:followers.html.twig";
    }
