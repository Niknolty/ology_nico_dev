...
class __TwigTemplate_00bffb3a8ffec216d872d7c1a2ae1112 extends Twig_Template
{
...
<sitemapindex xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/siteindex.xsd\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "inc_sitemaps"));
        foreach ($context['_seq'] as $context["_key"] => $context["inc_sitemap"]) {
            // line 4
            echo "    <sitemap>
        <loc>";
            // line 5
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "inc_sitemap"), "loc"), "html", null, true);
            echo "</loc>
        <lastmod>";
            // line 6
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "inc_sitemap"), "lastmod"), "html", null, true);
            echo "</lastmod>
    </sitemap>
    ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['inc_sitemap'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "OlogySocialBundle:FrontEnd:sitemap.html.twig";
    }
