...
class __TwigTemplate_8df3b276bd622ee2b1b8d06b79c904aa extends Twig_Template
{
    ...
    <div id=\"follow-form\">
        ";
        // line 7
        if (((twig_length_filter($this->env, $this->getContext($context, "ologies")) > 0) || (twig_length_filter($this->env, $this->getContext($context, "stashes")) > 0))) {
            // line 8
            echo "            <div id=\"follow-everything\" class=\"not-selected\">Follow Everything</div><br />
        ";
        }
        // line 10
        echo "        ";
        ...
        <div class=\"follow-ologies\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["ology"]) {
                ...
                echo "\" ologyOrStash=\"ology\"
                    class=\"";
                // line 15
                if (twig_in_filter($this->getAttribute($this->getContext($context, "ology"), "id"), $this->getContext($context, "followedOlogies"))) {
                    echo "is";
                } else {
                    echo "not";
                }
        ...
        <div class=\"follow-stashes\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["stash"]) {
                ...
                echo "\" ologyOrStash=\"stash\"
                     class=\"";
                // line 26
                if (twig_in_filter($this->getAttribute($this->getContext($context, "stash"), "id"), $this->getContext($context, "followedStashes"))) {
                    echo "is";
                } else {
                    echo "not";
                }
        ...
        // line 32
        echo "        <input type=\"hidden\" id=\"followee-id\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "followee"), "id"), "html", null, true);
        echo "\"/>
        ";
        // line 33
        if (((twig_length_filter($this->env, $this->getContext($context, "ologies")) > 0) || (twig_length_filter($this->env, $this->getContext($context, "stashes")) > 0))) {
            // line 34
            echo "        <input type=\"submit\" id=\"follow-submit\" value=\"Follow\" />
        ";
        }
        // line 36
        echo "    </div>
    ...
    {
        return "OlogySocialBundle:Follow:follow-user-popup.html.twig";
    }
