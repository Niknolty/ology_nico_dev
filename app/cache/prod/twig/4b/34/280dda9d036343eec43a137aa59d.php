...
/* OlogySocialBundle:Search:results.html.twig */
class __TwigTemplate_4b34280dda9d036343eec43a137aa59d extends Twig_Template
{
...
";
        // line 18
        if (array_key_exists("ologies", $context)) {
            // line 19
            echo "Ology
<table border=\"5\" width=1000 >
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["ology"]) {
                ...
                <td>";
                // line 27
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "ology"), "imageUrl"), "html", null, true);
                echo "</td>
                <td>";
                // line 28
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "ology"), "creationDate"), "d/m/Y"), "html", null, true);
                echo "</td>
                <td>";
                // line 29
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "ology"), "visibility"), "html", null, true);
                echo "</td>
                <td>";
                // line 30
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "ology"), "readOnly"), "html", null, true);
                echo "</td>
            </tr>
        ";
            }
...
<table border=\"5\" width=1000 >
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                ...
                <td>";
                // line 45
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "creationDate"), "html", null, true);
                echo "</td>
            </tr>
        ";
            }
...
";
    ...
    {
        return "OlogySocialBundle:Search:results.html.twig";
    }
