...
class __TwigTemplate_7592f76a4e3bf8a85ea805a74102888b extends Twig_Template
{
    ...
    {
        // line 1
        echo "Sponsor for featured Ologies

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_sponsor_store"), "html", null, true);
        echo "\" method=\"post\">
    Sponsor name: <input type=\"text\" id=\"sponsorname\" name=\"sponsorForm[name]\" /><br/><br/>
    HTML TAG: <textarea id=\"sponsortag\" name=\"sponsorForm[tag]\"></textarea><br/><br/>
    ...
    {
        return "OlogySocialBundle:Admin:sponsor.html.twig";
    }
