...
class __TwigTemplate_8973785fc87de918b093b0a6b67916a3 extends Twig_Template
{
    ...
    {
        // line 3
        echo "Check out the new post in <a href=\"";
...
\"<a href=\"";
        ...
        echo "</a>\" by <a href=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "websiteUrl"), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_profile", array("id" => $this->getContext($context, "posterId"))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getContext($context, "posterName"), "html", null, true);
        echo "</a>.<br />
";
    }
    ...
    {
        return "OlogySocialBundle:Email:NewPost.html.twig";
    }
