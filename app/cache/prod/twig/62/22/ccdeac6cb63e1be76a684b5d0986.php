...
class __TwigTemplate_6222ccdeac6cb63e1be76a684b5d0986 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        if (array_key_exists("msg", $context)) {
            ...
            echo "</a> has invited you to join <a href=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "websiteUrl"), "html", null, true);
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_splash_invite_general", array("inviteId" => $this->getContext($context, "inviteId"))), "html", null, true);
            echo "\">Ology</a> and left you this message:</p>
<p><b>";
            // line 5
...
<p><a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->getContext($context, "websiteUrl"), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_register_invite_general", array("inviteId" => $this->getContext($context, "inviteId"))), "html", null, true);
        echo "\">Accept your invite here</a>.</p>
...
";
    ...
    {
        return "OlogySocialBundle:Email:invite.html.twig";
    }
