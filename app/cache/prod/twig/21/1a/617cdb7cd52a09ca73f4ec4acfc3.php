...
/* OlogySocialBundle:Comment:create.html.twig */
class __TwigTemplate_211a617cdb7cd52a09ca73f4ec4acfc3 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (array_key_exists("showprompt", $context)) {
            // line 2
            echo "<form action=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_comment_store"), "html", null, true);
            echo "\" method=\"post\" ";
            echo $this->env->getExtension('form')->renderEnctype($this->getContext($context, "form"));
            echo " id=\"offline-form-comment\">
    ";
            // line 3
            echo $this->env->getExtension('form')->renderRest($this->getContext($context, "form"));
            echo "
    <input style=\"border: 0\" type=\"image\" class=\"comment-button comment-button-prompt\" src=\"";
            // line 4
...
";
            ...
            echo "\" method=\"post\" ";
            echo $this->env->getExtension('form')->renderEnctype($this->getContext($context, "form"));
            echo " id=\"form-comment\">
    ";
            // line 9
            echo $this->env->getExtension('form')->renderRest($this->getContext($context, "form"));
            echo "
    <input id=\"scroll-when-post-comment\" style=\"border: 0\" type=\"image\" class=\"comment-button\" src=\"";
            // line 10
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/ologysocial/img/comment_button_big.png"), "html", null, true);
            echo "\"/>
</form>
";
    ...
    {
        return "OlogySocialBundle:Comment:create.html.twig";
    }
