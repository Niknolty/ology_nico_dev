...
class __TwigTemplate_027208b61b5426a0b2c5460782306a74 extends Twig_Template
{
    ...
    {
        // line 3
        echo "Looks like you're kind of a big deal, because ";
        echo twig_escape_filter($this->env, $this->getContext($context, "inviterName"), "html", null, true);
        echo " has invited you to join <a href=\"";
...
You should return the favor by inviting them to ollow one of your ologies! Don't have any? No problem--find ologies on the <a href=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->getContext($context, "websiteUrl"), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_explore"), "html", null, true);
        echo "\">explore page</a> or get adventurous and <a href=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "websiteUrl"), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_website_create_ology"), "html", null, true);
        echo "\">create a new ology</a>.
";
    }

    public function getTemplateName()
    {
        return "OlogySocialBundle:Email:invite_ology.html.twig";
    }
