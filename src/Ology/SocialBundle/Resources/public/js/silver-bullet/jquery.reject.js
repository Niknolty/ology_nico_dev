...
(function($) {
	$.reject = function(opts) {
		var opts = $.extend(true,{
			reject : {
				msie5:true, msie6:true, msie7:true, firefox1:true, firefox2:true, firefox3:true, firefox4:true, firefox5:true, firefox6:true
				/*
			...
			display: ['chrome','firefox','msie'], // What browsers to display and their order (default set below)
			...
			header: 'Oops, you need to upgrade your browser!',
			paragraph1: 'My.Ology will work a lot better with a newer version.',
			paragraph2: '',
			close: true,
			closeMessage: '',
			closeLink: 'close',
